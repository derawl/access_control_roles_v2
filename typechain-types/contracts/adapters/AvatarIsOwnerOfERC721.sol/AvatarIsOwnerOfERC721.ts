...
export interface AvatarIsOwnerOfERC721Interface extends utils.Interface {
  functions: {
...
export interface AvatarIsOwnerOfERC721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AvatarIsOwnerOfERC721Interface;
